...
void main() {
  group('FakeProductsRepository', () {
    test('getProductsList returns global product list', () {
  ...
  test('fetchProductsList future returns global list', () async {
    final productsRepository = FakeProductsRepository();
    expect(
  ...
  test('watchProduct(1) stream emits first item', () {
    final productsRepository = FakeProductsRepository();
    expect(
  ...
  test('watchProduct(100) stream emits null', () {
    final productsRepository = FakeProductsRepository();
    expect(
