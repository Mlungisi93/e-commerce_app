...
class PaymentPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.listen<double>(cartTotalProvider, (_, cartTotal) {
      // If the cart total becomes 0, it means that the order has been fulfilled, relaying on FakePayment service placeOrder method which sets the cart total to zero line 48     await remoteCartRepository.setCart(uid, const Cart()); then
