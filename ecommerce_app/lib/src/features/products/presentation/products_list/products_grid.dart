...
class ProductsGrid extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // RiverPod gives us Async Value Type to handle 3 cases from Asynchronous -task run simultaneous data
    //Note: Whenever we watch a StreamProvider the widget will rebuild every time the stream emit a new value
