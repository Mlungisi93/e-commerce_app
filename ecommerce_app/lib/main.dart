...
Since GoRouter 8.0, imperatively pushing a route no longer changes the URL on web.

If you want to preserve the old behaviour (as we do in this course), add the following to your main method:
